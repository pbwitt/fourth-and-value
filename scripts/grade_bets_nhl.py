...
This script:
1. Fetches every pending NHL bet, across every user, from Supabase
...
def main():
    ...
    pending_nhl_bets = fetch_pending_bets('NHL')
    print(f"⏳ Found {len(pending_nhl_bets)} pending NHL bets (across all users)")
