...
from site_common import write_with_nav_raw, pretty_market, fmt_odds_american, kickoff_et, BRAND
...
from site_common import write_with_nav_raw, pretty_market, fmt_odds_american, fmt_pct, kickoff_et, BRAND
fmt_odds = fmt_odds_american
to_kick_et = kickoff_et
...
def html_page(cards_html, title, market_pairs, game_pairs, book_pairs, season=None, week=None):
...
def main():
    ...
    html = html_page(cards, args.title, market_pairs, game_pairs, book_pairs, season=args.season, week=args.week)
# (no manual .replace("__NAV__", ...) needed)
    ...
    write_with_nav_raw(args.out, html, active="Top Picks")
