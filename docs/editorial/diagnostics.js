...
(()=>{
 ...
 const labels={success:'Passed',failure:'Failed',skipped:'Not run',in_progress:'Running',queued:'Queued',not_checked:'Not checked',not_recorded:'Not recorded',ready:'Ready',current:'Current',stale:'Stale',unknown:'Not recorded',unvalidated:'Not validated',no_markets:'No usable markets',unavailable:'Unavailable',published:'Saved for publication',waiting_for_data:'Waiting for evidence',review:'Private draft awaiting approval',started:'Writing started',passed:'Passed',failed:'Failed'};
 ...
 const pill=value=>el('span',text(value),'pill '+(['success','ready','current','passed'].includes(value)?'good':['failure','failed','unavailable'].includes(value)?'bad':['stale','waiting_for_data','unvalidated'].includes(value)?'warn':''));
